<div id="content">
    <div class="ic">Скрытая Реклама</div>
    <div class="inner">
			    ...
			    <div class="grid_12">
					<div class="block">
						<div class="info-block">
							<a href="#" rel="nofollow" class="link">Ссылка</a> нажав на которую ничего не произойдет, тут был архив с этой темой.
						</div>
						<a href="#" class="button" rel="nofollow">Жми сюда!</a>
					</div>
				</div>
			</div>
			<div class="wrapper">
					...
					<div class="wrapper">
						<div class="grid_8 alpha">
							<div class="grid-inner">
			    				<h2 class="h-pad h-indent">Последние сообщения</h2>
								<div class="block">
									<div class="post">
										<div class="wrapper">
											<div class="info">
												<div class="wrapper">
													<div class="date">
														<span>Май</span><strong>15</strong>
													</div>
													<a href="#"><strong>Отметили День Рождения Сына друга!</strong></a><br>
												    Автор: <a href="#"><strong>админ</strong></a>
												</div>
											</div>
											<div class="comments">
												без коментариев!<span></span>
											</div>
										</div>
